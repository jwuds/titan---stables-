...
import NoIndexWrapper from '@/components/NoIndexWrapper.jsx';
                          ...
                          <Suspense fallback={<LoadingFallback />}>
                            <AnimatePresence mode="wait">
                              <Routes location={location} key={location.pathname}>
                                ...
                                {/* ADMIN AUTH ROUTE - NOINDEX */}
                                <Route path="/admin-login" element={<NoIndexWrapper><PageTransition><AdminLoginPage /></PageTransition></NoIndexWrapper>} />
                                <Route path="/login" element={<Navigate to="/admin-login" replace />} />
                                
                                {/* ADMIN ROUTES - PROTECTED AND NOINDEX */}
                                <Route path="/admin" element={<NoIndexWrapper><ProtectedRoute><AdminDashboard /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/global-standard" element={<NoIndexWrapper><ProtectedRoute><GlobalStandardEditor /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/meet-experts" element={<NoIndexWrapper><ProtectedRoute><MeetTheExpertsEditor /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/global-delivery" element={<NoIndexWrapper><ProtectedRoute><GlobalDeliveryEditor /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/delivery-reach" element={<NoIndexWrapper><ProtectedRoute><DeliveryReachVideoEditor /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/recent-matches" element={<NoIndexWrapper><ProtectedRoute><AdminRecentMatchesPage /></ProtectedRoute></NoIndexWrapper>} />
                                
                                <Route path="/admin/dashboard" element={<Navigate to="/admin" replace />} />
                                <Route path="/admin/blog" element={<NoIndexWrapper><ProtectedRoute><AdminBlogPage /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/blog/editor" element={<NoIndexWrapper><ProtectedRoute><AdminBlogEditorPage /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/blog/editor/:id" element={<NoIndexWrapper><ProtectedRoute><AdminBlogEditorPage /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/horses" element={<NoIndexWrapper><ProtectedRoute><AdminHorseManagementPage /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/horse-facts" element={<NoIndexWrapper><ProtectedRoute><AdminHorseFactsPage /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/faq-editor" element={<Navigate to="/admin/faqs" replace />} />
                                <Route path="/admin/faqs" element={<NoIndexWrapper><ProtectedRoute><AdminFAQDashboard /></ProtectedRoute></NoIndexWrapper>} />
                                <Route path="/admin/settings" element={<NoIndexWrapper><ProtectedRoute><AdminSettingsPage /></ProtectedRoute></NoIndexWrapper>} />
